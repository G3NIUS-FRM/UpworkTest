...
export const Benefits = () => {
  return (
    <>
      <div className="h-[40vh] w-full flex flex-col justify-center items-start gap-6 px-10">
        <span className="font-roboto font-[600] text-gray-400"> Benefits</span>
        <h3 className="text-[60px] font-gfs">We’ve cracked the code.</h3>
        <span className="font-roboto font-[400] text-gray-400">
          Area provides real insights, without the data overload.
        </span>
      </div>
      <div className="h-[40vh] w-full flex  justify-center items-start gap-6 mt-[3rem] px-10">
        <div className="flex flex-col justify-center items-start gap-4 border-t-2 border-t-gray-300 pt-[4rem]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none" // Establecido a negro
            overflow="visible"
          ...
          <h3 className="font-gfs text-[24px]">Amplify Insights</h3>
        ...
        <div className="flex flex-col justify-center items-start border-t-2 gap-4 border-t-gray-300 pt-[4rem]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            overflow="visible"
          ...
          <h3 className="font-gfs text-[24px]">Control Your Global Presence</h3>
          <p className="font-robot text-[16px] text-gray-500">
        ...
        <div className="flex flex-col justify-center items-start border-t-2 gap-4 border-t-gray-300 pt-[4rem]">
          ...
          <h3 className="font-gfs text-[24px]">Remove Language Barriers</h3>
          <p className="font-robot text-[16px] text-gray-500">
